...
Creazione del dataset contenete le coordinate GPS degli oli
...
La variabile palmitic presenta valori maggiori tra glioli del secondo cluster, mentre negli altri gruppi la mediana dei valori è circa allineata
...
Analogamente alla variabile palmitic, si nota un cluster 2 con una devianza within più elevata rispetto agli altri gruppi, che hanno anch'essi una mediana più bassa
il cluster 3 e 4 sono abbastanza simili tra loro, ma il cluster 4 ha dei valori outlier più distanti dalle code della distribuzione.
...
I cluster hanno delle mediane abbastanza simili tra loro, il che indica una bassa devianza between.
Il cluster 1 ha una devianza within più elevata.
Nel cluster 2 sono presenti una significativa quantità di valori outlier.
