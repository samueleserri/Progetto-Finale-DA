...
Mentre il gruppo 2 presenta numerosi valori outlier oltre che ad avere una devianza within più elevata.
...
Per confrontare l'accuratezza degli algoritmi di clustering visti si sceglie di usare l'indice ARI (adjusted rand index) e comparare i gruppi formati con le macro aree fornite dal dataset.
...
Guardando l'indice si evince che l'algorimo che suddivide in cluster con più accuratezza è pdfCluster, mentre PAM  è l'algoritmo con ARI peggiore.
