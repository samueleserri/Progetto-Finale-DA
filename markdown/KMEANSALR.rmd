...
barplot(prop.table(table(km.out$cluster, oliveALR$region),1), beside = T, legend = F, main = "Poporzione all'interno dei cluster", col = 2:7, cex.names = 0.70, las=2) 
legend("topright", legend = rownames(prop.table(table(km.out$cluster, oliveALR$region),1)), fill = 2:7, cex = 0.8, bty = "n")


barplot(prop.table(table(km.out$cluster, oliveALR$region),2), beside = T, legend = F, main = "", col = 2:7, cex.names = 0.70, las=2)
legend("topright", legend = rownames(prop.table(table(km.out$cluster, oliveALR$region),1)), fill = 2:7, cex = 0.8, bty = "n")
